...
```javascript
import maxBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-max-by@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-max-by/tags). For example,

```javascript
import maxBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-max-by@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-max-by@deno/mod.js';
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-max-by.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-max-by/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-max-by/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-max-by/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-max-by/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-max-by/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-max-by/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-max-by/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-max-by/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-max-by/main/LICENSE
